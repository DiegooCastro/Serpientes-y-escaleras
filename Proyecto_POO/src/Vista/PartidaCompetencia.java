 ...
 * @author Diego
 */
public class PartidaCompetencia extends javax.swing.JFrame {
    ...
    public PartidaCompetencia(String modalidad,String fichaJ1,String fichaJ2) {
        initComponents();
    ...
    private static PartidaCompetencia formulario; 
    ...
    private void initComponents() {
        ...
        jPanel1.add(lblFicha1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 660, -1, 90));

        lblFicha2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Recursos/ficha-jett-tablero.png"))); // NOI18N
        jPanel1.add(lblFicha2, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 660, 90, 90));
        ...
        lblTablero.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Recursos/tablero_facil.jpg"))); // NOI18N
            ...
            if (contadorJ1  == contadorJ2) {
                ...
                if (!"Normal".equals(tipoFicha)) {
                    try {
                        ...
                        new CasillaEspecial(tipoFicha,String.valueOf(posicionFinal),"Competencia","").setVisible(true);
    ...
    private void btnDadoJ1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDadoJ1ActionPerformed
        ...
        new Dado(String.valueOf(numeroDado),"Competencia").setVisible(true);       
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PartidaCompetencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PartidaCompetencia(args[0],args[1],args[2]).setVisible(true);
            }
        });
    }
