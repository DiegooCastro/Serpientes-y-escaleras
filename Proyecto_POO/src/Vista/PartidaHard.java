 ...
 * @author Diego
 */
public class PartidaHard extends javax.swing.JFrame {
    ...
    public PartidaHard(String modalidad,String ficha) {
        initComponents();
    ...
    private static PartidaHard formulario; 
    ...
    private void initComponents() {
        ...
        jPanel1.add(lblFicha1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 180, -1, 100));
        ...
        jPanel1.add(btnDado, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 160, 50));

        lblTablero.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Recursos/tablero_dificil.jpg"))); // NOI18N
        jPanel1.add(lblTablero, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1710, 920));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1720, 930));
        ...
        if (contadorJ1 >= numCasillas - 1) {
            ...
            if (!"Normal".equals(tipoFicha)) {
                try {
                    ...
                    new CasillaEspecialHard(tipoFicha,String.valueOf(posicionFinal),"Individual","").setVisible(true);
    ...
    private void btnDadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDadoActionPerformed
        ...
        new DadoHard(String.valueOf(numeroDado),"Individual").setVisible(true);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PartidaHard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PartidaHard(args[0],args[1]).setVisible(true);
            }
        });
    }
